...
The memory service includes a built-in web interface for browsing, searching, and managing memories without using the CLI.
...
| **Semantic search** | Search memories by meaning — results ranked by score (highest first) |
...
| **Short/Long-term badge** | Memories with a `run_id` show an orange **短期** badge; long-term memories show a purple **长期** badge |
| **Score display** | Search results show a relevance score percentage |
| **Expand/Collapse** | Click any memory card to expand its full content |
...
│  │ kiro-cli: always use exec(pty=true)...     │  │
│  └────────────────────────────────────────────┘  │
│  ┌────────────────────────────────────────────┐  │
│  │ [dev] [长期]                2026-04-06     │  │
